...
#include "../../Graphics/Core/RenderMode.h"
...
namespace GameDev2D
{
    ...
    public:
        ...
        //
        void SetTextureData(unsigned int textureId, TextureData* textureData, unsigned int mipmapLevel);
        ...
        //Converts the RenderMode into the OpenGL constant
